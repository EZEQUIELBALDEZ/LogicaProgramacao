 ...
 * 
 * @POSICAO-CURSOR = 5649; 
 * @DOBRAMENTO-CODIGO = [19, 117, 141, 170, 196, 249, 349, 389, 422, 460, 483, 631, 746, 778, 786, 824, 832, 856, 864, 875, 885, 893, 904, 917];
 * @PONTOS-DE-PARADA = ;
 ...
 * Você pode apagá-la se estiver utilizando outro editor.
 * 
 * @POSICAO-CURSOR = 10029; 
 * @DOBRAMENTO-CODIGO = [8, 19, 117, 143, 175, 202, 231, 260, 410, 447, 489, 518, 670, 794, 826, 834, 872, 880, 904, 912, 923, 933, 941, 952];
 * @PONTOS-DE-PARADA = ;
 * @SIMBOLOS-INSPECIONADOS = ;
 * @FILTRO-ARVORE-TIPOS-DE-DADO = inteiro, real, logico, cadeia, caracter, vazio;
 * @FILTRO-ARVORE-TIPOS-DE-SIMBOLO = variavel, vetor, matriz, funcao;
